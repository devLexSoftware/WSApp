...
@Component({
  selector: 'app-user-cliente-obras',
  templateUrl: './user-cliente-obras.page.html',
  styleUrls: ['./user-cliente-obras.page.scss'],
})
export class UserClienteObrasPage implements OnInit {
  obras: any[] = [];
  ...
  verCompras(obra){
    this.router.navigate(['/user-cliente-compras', obra]);
  }
